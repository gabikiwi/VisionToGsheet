...
var clientId = '824875288590-u5turaai4luqn2cttfeacgijcspaufla.apps.googleusercontent.com';
var clientSecret = 'sOwoBwiVfeqImKQcbgQVaup1';
var redirectUrl = 'http://localhost:8080/oauth2callback';
var projectId = 'gabriel-visionapi-179707';
var bucketName = 'gabriel-visionapi-179707.appspot.com';

var credentialsApiKey = 'AIzaSyAKG0PEp0nuhBkhOGHS0tA6KW4MiRZso7Q';

module.exports = {
  port: process.env.PORT || 8080,

  // Secret is used by sessions to encrypt the cookie.
  secret: process.env.SESSION_SECRET || 'sOwoBwiVfeqImKQcbgQVaup1',
